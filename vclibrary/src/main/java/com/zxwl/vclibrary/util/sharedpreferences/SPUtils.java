package com.zxwl.vclibrary.util.sharedpreferences;
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = LocContext.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp =  LocContext.getContext().getSharedPreferences(spName, mode);
    }
