...
object NetWorkUtils {
    ...
    fun openWirelessSettings() {
       LocContext.getContext().startActivity(
    ...
    fun getMobileDataEnabled(): Boolean {
        try {
            val tm = LocContext.getContext().getSystemService(Context.TELEPHONY_SERVICE) as TelephonyManager
                ?: return false
    ...
    fun getWifiEnabled(): Boolean {
        ...
        val manager = LocContext.getContext().getSystemService(WIFI_SERVICE) as WifiManager
            ?: return false
    ...
    fun isWifiConnected(): Boolean {
        val cm =
            LocContext.getContext().getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
                ?: return false
...
//        } catch (e: SocketException) {
    ...
    fun getIpAddressByWifi(): String {
        @SuppressLint("WifiManagerLeak")
        val wm = LocContext.getContext().getSystemService(Context.WIFI_SERVICE) as WifiManager
            ?: return ""
    ...
    fun getNetType(): NetType {
        val connMgr = LocContext.getContext()
