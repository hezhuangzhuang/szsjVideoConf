package com.zxwl.vclibrary.util.permission;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(LocContext.getContext().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = LocContext.getContext().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(LocContext.getContext(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(LocContext.getContext());
    }
    ...
    public static void requestWriteSettings(final SimpleCallback callback) {
        ...
        PermissionActivity.start(LocContext.getContext(), PermissionActivity.TYPE_WRITE_SETTINGS);
    }

    @TargetApi(Build.VERSION_CODES.M)
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        Intent intent = new Intent(Settings.ACTION_MANAGE_WRITE_SETTINGS);
        intent.setData(Uri.parse("package:" + LocContext.getContext().getPackageName()));
...
//        if (Build.VERSION.SDK_INT >=26) {
            ...
            AppOpsManager aom = (AppOpsManager) LocContext.getContext().getSystemService(Context.APP_OPS_SERVICE);
            if (aom == null) {
                return false;
            }
            int mode = aom.checkOpNoThrow(
                    ...
                    LocContext.getContext().getPackageName()
            );
            return mode == AppOpsManager.MODE_ALLOWED || mode == AppOpsManager.MODE_IGNORED;
        }
        return Settings.canDrawOverlays(LocContext.getContext());
    }
    ...
    public static void requestDrawOverlays(final SimpleCallback callback) {
        ...
        PermissionActivity.start(LocContext.getContext(), PermissionActivity.TYPE_DRAW_OVERLAYS);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        LocContext.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(LocContext.getContext(), PermissionActivity.TYPE_RUNTIME);
    }
     ...
     * 请求麦克风和摄像头，手机信息权限
     *
     * @param fullCallback 获取权限的回调
     */
    public static void requestCameraAndMicroPermission(PermissionUtils.FullCallback fullCallback) {
...
//                PermissionConstants.PHONE,
     ...
     * @return
     */
    public static boolean hasBackgroundStartPermissionInMIUI() {
        AppOpsManager ops = (AppOpsManager) LocContext.getContext().getSystemService(Context.APP_OPS_SERVICE);
        try {
            ...
            Integer result = (Integer) method.invoke(ops, opValue, android.os.Process.myUid(), LocContext.getContext().getPackageName());
            return result == AppOpsManager.MODE_ALLOWED;
        } catch (Exception e) {
//            Log.e("hasBackgroundStartPermissionInMIUI", e.getMsg());
            return false;
        }
    }
...
//            localIntent.putExtra("extra_pkgname",  LocContext.getContext().getPackageName());
