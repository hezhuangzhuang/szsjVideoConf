...
public class DateUtil {
    ...
    public static final String LEGITIMATE_TIME = "2020-10-29 23:59";
...
//        strTime = dateToString(date, "HH:mm:ss");
    ...
    public static boolean test(String time) {
        long l = stringToLong(time, FORMAT_DATE_TIME);
    ...
    public static String formatTimeFString(long longTime) {
        String time = "%2d:%2d";
        int min = parseLongToInt((longTime) / 60);
     ...
     * @return
     */
    private static int parseLongToInt(long value) {
