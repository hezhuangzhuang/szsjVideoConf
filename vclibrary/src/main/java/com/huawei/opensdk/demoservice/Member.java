...
public class Member implements Serializable {
    ...
    public boolean isInConf() {
        return ConfConstant.ParticipantStatus.IN_CONF == status;
    }

    public boolean isChair() {
        return TsdkConfRole.TSDK_E_CONF_ROLE_CHAIRMAN == role;
    }
    ...
    public void update(TsdkAttendee attendeeInfo) {
        ...
        setReqTalk(attendeeStatusInfo.getIsReqTalk() == 1 ? true : false);
