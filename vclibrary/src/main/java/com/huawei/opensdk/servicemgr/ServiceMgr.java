...
public class ServiceMgr {
    ...
    private static final String CONTACT_FILE_PATH = LocContext.getContext().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS) + File.separator + "tupcontact";
...
//        logParam.setPath(Environment.getExternalStorageDirectory() + File.separator + "ECSDKDemo" + "/");
        logParam.setPath(LocContext.getContext().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS) + File.separator + "ECSDKDemo" + "/");
