...
public class CallMgr implements ICallMgr
{
    ...
    public TsdkMediaQosInfo getCallQuality(int callid)
    {
        TsdkMediaQosInfo mediaQosInfos = TsdkManager.getInstance().getCallManager().getCallQuality(callid);
...
//        TupCallManager callManager = TupMgr.getInstance().getCallManagerIns();
    ...
    public void handleCallConnected(TsdkCall call){
        ...
        if (null == call)
        {
            LogUtil.e(TAG, "handleCallConnected call obj is null");
            return;
        }
...
//        mCallNotification.onCallEventNotify(CallConstant.CallEvent.CALL_ENDED, callInfo);
    ...
    //语音接听的时间
    private long voiceAnswerTime = 0;

    //视频接听的时间
    private long videoAnswerTime = 0;

    /**
     * 设置语音接通的时间
     *
     * @param voiceAnswerTime
     */
    public void setVoiceAnswerTime(long voiceAnswerTime) {
        this.voiceAnswerTime = voiceAnswerTime;
    }
     ...
     * @return
     */
    public long getVoiceAnswerTime() {
        return voiceAnswerTime;
    }
     ...
     * @param voiceAnswerTime
     */
    public void setVideoAnswerTime(long videoAnswerTime) {
        this.videoAnswerTime = videoAnswerTime;
    }
     ...
     * @return
     */
    public long getVideoAnswerTime() {
        return videoAnswerTime;
    }
}
