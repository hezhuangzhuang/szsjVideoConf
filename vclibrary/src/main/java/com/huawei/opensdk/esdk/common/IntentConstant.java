package com.huawei.opensdk.esdk.common;
...
public class IntentConstant
{
    ...
    public static final String VOICE_ACTIVITY_ACTION = "android.intent.action.voice_activity";
    ...
    public static final String VIDEO_CONF_MANAGER_ACTIVITY_ACTION = "android.intent.action.video_conf_manager_activity";
    public static final String VOICE_CONF_MANAGER_ACTIVITY_ACTION = "android.intent.action.voice_conf_manager_activity";
