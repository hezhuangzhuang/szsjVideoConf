package com.hw.provider.huawei.commonservice.util;
...
public final class DeviceManager {
    ...
    /**
     * This method is used to is websocketIP address boolean.
     * 是否为本地ip地址
     *
    ...
    /**
     * This method is used to get vpn local websocketIP.
     * 获取本地VPN ip地址
     *
     * @return String  Return the vpn local websocketIP
     * 返回本地VPN ip地址
     */
    ...
    /**
     * This method is used to get websocketIP address.
     * 获取本地ip地址
     *
     * @return String Return websocketIP address
     * 返回本地ip地址
     */
            ...
            for (Enumeration<NetworkInterface> en = networkInfo; en
                ...
                for (Enumeration<InetAddress> enumIpAddr = intfAddress; enumIpAddr
                    ...
                    if (!inetAddress.isLoopbackAddress()) {
                        ...
                        if (isIPV4Addr(ip)) {
//                            LogUtil.i("getLocalIp", "websocketIP is " + websocketIP);
                            return ip;
                        }
                    }
                }
     ...
     * 是否为ipv4 地址
     *
     * @param ipAddr Indicates websocketIP address
     *               ip地址
     * @return boolean If yes return TRUE, otherwise return false
     * 是返回TRUE，否则返回false
     */
    ...
    /**
     * This method is used to get the websocketIP address.
     * 获取本地ip地址
     */
