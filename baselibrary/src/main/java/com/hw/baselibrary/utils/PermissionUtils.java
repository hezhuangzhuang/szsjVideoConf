...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(BaseApp.context.getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = BaseApp.context.getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(BaseApp.context, permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(BaseApp.context);
    }
    ...
    public static void requestWriteSettings(final SimpleCallback callback) {
        ...
        PermissionActivity.start(BaseApp.context, PermissionActivity.TYPE_WRITE_SETTINGS);
    }

    @TargetApi(Build.VERSION_CODES.M)
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        Intent intent = new Intent(Settings.ACTION_MANAGE_WRITE_SETTINGS);
        intent.setData(Uri.parse("package:" + BaseApp.context.getPackageName()));
    ...
    public static boolean isGrantedDrawOverlays() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            AppOpsManager aom = (AppOpsManager) BaseApp.context.getSystemService(Context.APP_OPS_SERVICE);
            if (aom == null) {
                return false;
            }
        ...
        return Settings.canDrawOverlays(BaseApp.context);
    }
    ...
    public static void requestDrawOverlays(final SimpleCallback callback) {
        ...
        PermissionActivity.start(BaseApp.context, PermissionActivity.TYPE_DRAW_OVERLAYS);
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(BaseApp.context, PermissionActivity.TYPE_RUNTIME);
    }
