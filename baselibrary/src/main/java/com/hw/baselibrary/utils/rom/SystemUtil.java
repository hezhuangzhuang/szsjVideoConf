...
public class SystemUtil {
    ...
    public static String getSystem() {
        String sysType = SPStaticUtils.getString("sysType", "");
        if (TextUtils.isEmpty(sysType)) {
            try {
                ...
                SPStaticUtils.put("sysType", sysType);
//                PreferenceUtil.getString(App.getContext(),);
            } catch (IOException e) {
                e.printStackTrace();
                return sysType;
            }
    ...
    public static boolean isEMUI() {
        return SYS_EMUI.equals(getSystemNew());
    }
    ...
    public static boolean isIgnoringBatteryOptimizations() {
        ...
        PowerManager powerManager = (PowerManager) BaseApp.context.getSystemService(Context.POWER_SERVICE);
        if (powerManager != null) {
            isIgnoring = powerManager.isIgnoringBatteryOptimizations(BaseApp.context.getPackageName());
        }
        return isIgnoring;
    }
