package com.hw.baselibrary.utils.sharedpreferences;
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = BaseApp.context.getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = BaseApp.context.getSharedPreferences(spName, mode);
    }
