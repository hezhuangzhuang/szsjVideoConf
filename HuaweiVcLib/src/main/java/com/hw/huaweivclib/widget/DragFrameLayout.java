package com.hw.huaweivclib.widget;
...
//        margin_edge = 10;
    ...
    private void onMove() {
        ...
        LogUtil.e(UIConstants.DEMO_TAG,"onMove: getLeft=" + getLeft() + " dx=" + dx + " dy=" + dy);
        setPosition1(dx, dy);
        //setPosition2(dx, dy);
        //setPosition3(dx, dy);
        //setPosition4(dx, dy);
...
//        LogUtil.e(UIConstants.DEMO_TAG,"scroll: getScrollX=" + getScrollX() + " getScrollY=" + getScrollY());
...
//        }
        lastOffset = 0;
        scroller.startScroll(getScrollX(), getScrollY(), 0, 0);
        invalidate();
    }
    ...
    public void computeScroll() {
        if (scroller.computeScrollOffset()) {
            LogUtil.e(UIConstants.DEMO_TAG,"scroll: getLeft=" + getLeft() + " currX=" + scroller.getCurrX());
